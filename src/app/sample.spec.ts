...
describe('Ensure that the app starts', () => {
    ...
    it(`should have as title 'Apex Brasil - Prova de Conceito'`, async () => {
        const { fixture } = setup();
        const app = fixture.debugElement.componentInstance;
        expect(app.title).toEqual('Apex Brasil - Prova de Conceito');
    });
    ...
    it('should not navigate to guarded component', async () => {
        ...
        const canNavigate = await run(() => router.navigateByUrl('/course-view'));
